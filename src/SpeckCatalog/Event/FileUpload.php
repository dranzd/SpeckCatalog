...
class FileUpload
{
    public function preFileUpload($e)
    {
        ...
        $catalogOptions = $sl->get('speckcatalog_module_options');
    ...
    public function postFileUpload($e)
    {
        ...
        switch ($params['params']['file_type']) {
            case 'productImage' :
                $imageService = $sl->get('speckcatalog_product_image_service');
            ...
            case 'productDocument' :
                $documentService = $sl->get('speckcatalog_document_service');
                ...
                break;
            case 'optionImage' :
                $imageService = $sl->get('speckcatalog_option_image_service');
